...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/lost-found', name: 'lostFound', component: LostFoundView, meta: { title: '失物招领' } },
  { path: '/group-buy', name: 'groupBuy', component: GroupBuyView, meta: { title: '拼单搭子' } },
  ...
  { path: '/message', name: 'message', component: MessageView, meta: { title: '消息中心' } },
  { path: '/user', name: 'user', component: UserCenterView, meta: { title: '个人中心' } },
]
